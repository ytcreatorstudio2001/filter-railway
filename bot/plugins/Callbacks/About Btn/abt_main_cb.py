...
async def cb_about(bot, update: CallbackQuery):
    ...
    text+=f"""\n<b><i>Bot Support:</i></b> <a href="https://t.me/moviehub_plus">@mobiehub_plus</a>\n"""
    text+="""\n<b><i>Source Code:</i></b> <a href="https://t.me/moviehub_plus">Source</a>"""

    buttons = [
        [
            InlineKeyboardButton
                (
                    "My Dev ⚡", url="https://t.me/akhil_tg"
                ),
